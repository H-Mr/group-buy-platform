...
import cn.hjw.dev.domain.trade.adapter.repository.ITradeRepository;
import cn.hjw.dev.domain.trade.model.aggregate.GroupBuyOrderAggregate;
import cn.hjw.dev.domain.trade.model.aggregate.GroupBuyTeamSettlementAggregate;
import cn.hjw.dev.domain.trade.model.entity.*;
import cn.hjw.dev.domain.trade.model.valobj.ActivityStatusEnumVO;
import cn.hjw.dev.domain.trade.model.valobj.GroupBuyOrderEnumVO;
import cn.hjw.dev.domain.trade.model.valobj.GroupBuyProgressVO;
import cn.hjw.dev.domain.trade.model.valobj.TradeOrderStatusEnumVO;
import cn.hjw.dev.infrastructure.dao.IGroupBuyActivityDao;
import cn.hjw.dev.infrastructure.dao.IGroupBuyOrderDao;
import cn.hjw.dev.infrastructure.dao.IGroupBuyOrderListDao;
import cn.hjw.dev.infrastructure.dao.INotifyTaskDao;
...
import cn.hjw.dev.infrastructure.dao.po.NotifyTask;
import cn.hjw.dev.infrastructure.dcc.DynamicConfigCenter;
import cn.hjw.dev.types.common.Constants;
    ...
    public MarketPayOrderEntity lockMarketPayOrder(GroupBuyOrderAggregate groupBuyOrderAggregate) {
        ...
        GroupBuyOrderList groupBuyOrderListReq = GroupBuyOrderList.builder()
                ...
                .bizId(payActivityEntity.getActivityId() +
                                    ...
                                    Constants.UNDERLINE +
                                    (userTakeOrderCount+1)) // 构建 bizId 唯一值；活动id_用户id_参与次数累加
