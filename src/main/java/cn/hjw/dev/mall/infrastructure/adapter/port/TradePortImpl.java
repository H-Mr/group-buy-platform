package cn.hjw.dev.mall.infrastructure.adapter.port;

import cn.hjw.dev.domain.trade.adapter.port.ITradePort;
import cn.hjw.dev.domain.trade.model.entity.NotifyTaskEntity;
import cn.hjw.dev.infrastructure.gateway.GroupBuyNotifyService;
import cn.hjw.dev.infrastructure.redis.IRedisService;
import cn.hjw.dev.types.enums.NotifyTaskHTTPEnumVO;
...
public class TradePortImpl implements ITradePort {
    ...
    @Resource
    private GroupBuyNotifyService groupBuyNotifyService; // 拼团回调服务,通过okhttp调用回调接口
    @Resource
